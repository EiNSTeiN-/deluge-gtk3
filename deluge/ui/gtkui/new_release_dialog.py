...
class NewReleaseDialog:
    ...
    def show(self, available_version):
        ...
        if deluge.common.windows_check() or deluge.common.osx_check():
            ...
            glade.get_object("image_new_release").set_from_icon_name("deluge", 4)
        glade.get_object("label_available_version").set_text(available_version)
        glade.get_object("label_client_version").set_text(
            deluge.common.get_version())
        self.chk_not_show_dialog = glade.get_object("chk_do_not_show_new_release")
        ...
        if client.connected():
            ...
            if not client.is_classicmode():
                glade.get_object("label_client_version_text").set_label(_("<i>Client Version</i>"))
